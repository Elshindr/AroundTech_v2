...
export default function ModalChildEditNatureComponent(props) {
    ...
    const [isChargeValue, setIsChargeValue] = useState(props.oldInputIsCharge ? '1' : '0');
    const [isBonusValue, setIsBonusValue] = useState(props.oldInputIsBonus ? '1' : '0');
        ...
        <Form>
            ...
            {isBonusValue === "1" &&
                <Form.Group className="mb-3" controlId="%Prime">
                    ...
                    <Form.Control type="text" ref={props.inputPercentageEdit} value={percentageValue} onChange={(e) => { setPercentageValue(e.target.value); }} disabled={isChargeValue === "0"} />
                </Form.Group>
            }
